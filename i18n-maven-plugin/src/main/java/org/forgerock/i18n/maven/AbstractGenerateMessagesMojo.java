...
abstract class AbstractGenerateMessagesMojo extends AbstractMojo
{
      ...
      throws MojoExecutionException
  {
    ...
    final File sourceFile = messageFile
        .getResourceFile(resourceDirectory);
    final File outputFile = messageFile
        .getOutputFile(targetDirectory);
    ...
    try
    {
          ...
          .readLine())
      {
        ...
        {
          final Map<MessagePropertyKey, String> propertyMap = new TreeMap<MessagePropertyKey, String>();
              ...
              .entrySet())
          {
            ...
            message.setConstructorArguments(
                messageFile.getClassName() + ".class", "RESOURCE",
