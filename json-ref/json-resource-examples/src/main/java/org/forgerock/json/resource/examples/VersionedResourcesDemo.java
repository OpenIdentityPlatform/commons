...
public final class VersionedResourcesDemo {
    ...
    private static Context apiCtx(String resourceVersion) {
        return new AcceptAPIVersionContext(ctx(), "PROTOCOL_NAME", AcceptAPIVersion.newBuilder()
                .withDefaultResourceVersion("1.0").withDefaultResourceVersion(resourceVersion).build());
    }
