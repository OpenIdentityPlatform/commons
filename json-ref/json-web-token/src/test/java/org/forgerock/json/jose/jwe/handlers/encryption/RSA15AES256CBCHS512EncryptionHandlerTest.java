 ...
 */
public class RSA15AES256CBCHS512EncryptionHandlerTest {

    private RSA15AES256CBCHS512EncryptionHandler handler;
    private byte[] key;
    ...
    public void createEncryptionHandler() throws NoSuchAlgorithmException {
        ...
        handler = new RSA15AES256CBCHS512EncryptionHandler(new SigningManager());
