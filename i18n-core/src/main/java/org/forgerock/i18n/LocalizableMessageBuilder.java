    ...
    CharSequence, Serializable
{
   ...
   */
  public LocalizableMessageBuilder(
      final LocalizableMessageBuilder builder)
      throws NullPointerException
  {
   ...
   *           greater than {@code end}, or {@code end} is greater than
   *           {@code csq.length()}.
   * @throws NullPointerException
   *           If {@code cs} was {@code null}.
   */
   ...
   *           If {@code message} was {@code null}.
   */
  public LocalizableMessageBuilder append(
      final LocalizableMessage message) throws NullPointerException
  {
    if (message == null)
    {
   ...
   * locale. The subsequence starts with the {@code char} value at the specified
