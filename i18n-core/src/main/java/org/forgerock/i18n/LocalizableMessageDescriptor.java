...
public final class LocalizableMessageDescriptor
{
   ...
   */
  public static final class Arg0 extends
      AbstractLocalizableMessageDescriptor
  {
     ...
     *          {@code ResourceBundle}. The class may also be retrieved in order
     *          to uniquely identify the source of a message, for example using
     ...
     * @param ordinal
     *          The ordinal associated with this descriptor or {@code -1} if
     *          undefined. A message can be uniquely identified by its ordinal
     *          and class.
     */
    public Arg0(final Class<?> sourceClass,
        final String resourceName, final String key, final int ordinal)
    {
      ...
      AbstractLocalizableMessageDescriptor
  {
     ...
     *          and class.
     */
    public Arg1(final Class<?> sourceClass,
        final String resourceName, final String key, final int ordinal)
    {
      super(sourceClass, resourceName, key, ordinal);
    }
      ...
      AbstractLocalizableMessageDescriptor
  {
     ...
     *          and class.
     */
    public Arg2(final Class<?> sourceClass,
        final String resourceName, final String key, final int ordinal)
    {
      super(sourceClass, resourceName, key, ordinal);
    }
      ...
      AbstractLocalizableMessageDescriptor
  {
     ...
     *          and class.
     */
    public Arg3(final Class<?> sourceClass,
        final String resourceName, final String key, final int ordinal)
    {
      super(sourceClass, resourceName, key, ordinal);
    }
      ...
      AbstractLocalizableMessageDescriptor
  {
     ...
     *          and class.
     */
    public Arg4(final Class<?> sourceClass,
        final String resourceName, final String key, final int ordinal)
    {
      super(sourceClass, resourceName, key, ordinal);
    }
      ...
      AbstractLocalizableMessageDescriptor
  {
     ...
     *          and class.
     */
    public Arg5(final Class<?> sourceClass,
        final String resourceName, final String key, final int ordinal)
    {
      super(sourceClass, resourceName, key, ordinal);
    }
      ...
      AbstractLocalizableMessageDescriptor
  {
     ...
     *          and class.
     */
    public Arg6(final Class<?> sourceClass,
        final String resourceName, final String key, final int ordinal)
    {
      super(sourceClass, resourceName, key, ordinal);
    }
      ...
      AbstractLocalizableMessageDescriptor
  {
     ...
     *          and class.
     */
    public Arg7(final Class<?> sourceClass,
        final String resourceName, final String key, final int ordinal)
    {
      super(sourceClass, resourceName, key, ordinal);
    }
      ...
      extends AbstractLocalizableMessageDescriptor
  {
     ...
     *          and class.
     */
    public Arg8(final Class<?> sourceClass,
        final String resourceName, final String key, final int ordinal)
    {
      super(sourceClass, resourceName, key, ordinal);
    }
      ...
      extends AbstractLocalizableMessageDescriptor
  {
     ...
     *          and class.
     */
    public Arg9(final Class<?> sourceClass,
        final String resourceName, final String key, final int ordinal)
    {
      super(sourceClass, resourceName, key, ordinal);
    }
   ...
   */
  public static final class ArgN extends
      AbstractLocalizableMessageDescriptor
  {
     ...
     *          and class.
     */
    public ArgN(final Class<?> sourceClass,
        final String resourceName, final String key, final int ordinal)
    {
      super(sourceClass, resourceName, key, ordinal);
    }
  ...
  static abstract class AbstractLocalizableMessageDescriptor
  {
    ...
    /*
     * The class in which this descriptor is defined. This class will be used to
     * obtain the ClassLoader for retrieving the ResourceBundle. The class may
     * also be retrieved in order to uniquely identify the source of a message,
     * for example using getClass().getPackage().getName().
     */
    ...
    /*
     * The ordinal associated with this descriptor or -1 if undefined. A message
     * can be uniquely identified by its ordinal and class.
     */
        ...
        throws NullPointerException
    {
      ...
      cachedFormatString = new CachedFormatString(locale,
          formatString);
