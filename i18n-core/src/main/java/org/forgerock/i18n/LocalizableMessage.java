...
public final class LocalizableMessage implements CharSequence,
    Formattable, Comparable<LocalizableMessage>, Serializable
{
   ...
   */
  public static final LocalizableMessage EMPTY = LocalizableMessage
      .raw("");
   ...
   */
  public static LocalizableMessage raw(
      final CharSequence formatString, final Object... args)
      throws NullPointerException
  {
   ...
   */
  LocalizableMessage(
      final AbstractLocalizableMessageDescriptor descriptor,
      final Object... args)
  {
   ...
   *          truncated to {@code precision} characters even if the
   *          {@code width} is greater than the {@code precision}. If
   *          {@code precision} is {@code -1} then there is no explicit limit on
  ...
  /**
   * Returns a new {@code CharSequence} which is a subsequence of the
   * {@code String} representation of this message in the specified locale. The
   * subsequence starts with the {@code char} value at the specified index and
   * ends with the {@code char} value at index {@code end - 1} . The length (in
   * {@code char}s) of the returned sequence is {@code end - start}, so if
   * {@code start == end} then an empty sequence is returned.
   ...
   *           If {@code locale} was {@code null}.
   */
  public CharSequence subSequence(final Locale locale,
