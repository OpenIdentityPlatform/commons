...
final class BloomFilterPool<T> {
     ...
     */
    BloomFilterPool(final BloomFilterFactory<T> factory, final int maxBuckets,
        ...
        this.bucketNumbers = new BitSet(maxBuckets);
        ...
        this.takenBucketNumbers = synchronizedMap(new IdentityHashMap<BloomFilter<T>, Integer>(maxBuckets));
    }
