 ...
 * clients and servers. Refer to the appropriate class, e.g. {@link Client}, for
 * the list of supported options.
 */
public final class Options {
    /*
     * FIXME: this API has been mostly copied from the LDAP SDK. Perhaps we
     * should consider moving it to forgerock-util?
     */

    private static final Options DEFAULT = unmodifiable(defaultOptions());
     ...
     */
    public static Options unmodifiable(final Options options) {
