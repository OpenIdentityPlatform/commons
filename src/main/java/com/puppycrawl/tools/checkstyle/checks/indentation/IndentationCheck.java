...
public class IndentationCheck extends Check
{
    ...
    /** how much to indent throws in a method declaration */
    ...
    /**
     * Set the method declaration throws indentation level.
     *
     * @param aAmount   the method declaration throws indentation level.
     */
    public void setThrowsIndent(int aAmount)
    {
        mThrowsIndentationAmount = aAmount;
    }

    /**
     * Get the method declaration throws indentation level.
     *
     * @return the method declaration throws indentation level.
     */
    public int getThrowsIndent()
    {
        return mThrowsIndentationAmount;
    }
