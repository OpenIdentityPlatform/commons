...
public class OpenIdConnectVerificationException extends Exception {
     ...
     */
    public OpenIdConnectVerificationException(final String message) {
        super(message);
    }
     ...
     */
    public OpenIdConnectVerificationException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause The cause.
     */
    public OpenIdConnectVerificationException(final Throwable cause) {
        super(cause);
    }
