...
public class AuthModuleOne implements ServerAuthModule {
    ...
    public AuthStatus validateRequest(MessageInfo messageInfo, Subject clientSubject, Subject serviceSubject)
        ...
        String header = request.getHeader("X-Jaspi-Auth1-Validate-Request".toLowerCase());
        ...
        throw new AuthException("X-Jaspi-Auth1-Validate-Request header not set, so throwing AuthException.");
    }
    ...
    public AuthStatus secureResponse(MessageInfo messageInfo, Subject serviceSubject) throws AuthException {
        ...
        String header = request.getHeader("X-Jaspi-Auth1-Secure-Response".toLowerCase());
        ...
        throw new AuthException("X-Jaspi-Auth1-Secure-Response header not set, so throwing AuthException.");
    }
