...
public class StatusResource implements SingletonResourceProvider {
    ...
    public void readInstance(ServerContext context, ReadRequest request, ResultHandler<Resource> handler) {
        handler.handleResult(new Resource("Status", "0", JsonValue.json(JsonValue.object(JsonValue.field("State", "READY")))));
    }
