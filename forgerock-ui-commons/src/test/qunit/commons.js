            ...
            QUnit.asyncTest("Navigation - add new link", function () {
                ModuleLoader.load("org/forgerock/commons/ui/common/components/Navigation").then(function (Navigation) {
                    Navigation.init(function () {
                        ...
                        Navigation.addLink({"url": "#test/", "name": "New second-level link"}, "user", "examples");
                        ...
                        Navigation.configuration.links.user.urls.examples.urls = [];

                        Navigation.addLink({"url": "#test/", "name": "New second-level link"}, "user", "examples");
                        QUnit.equal(Navigation.configuration.links.user.urls.examples.urls.length, 1, "New second-level link was added to the link which has second level");

                        Navigation.addLink({"url": "#test/", "name": "New second-level link"}, "user", "examples");
                        QUnit.equal(Navigation.configuration.links.user.urls.examples.urls.length, 1, "New second-level link was not added as it is already present at this level");
