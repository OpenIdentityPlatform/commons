...
/**
 * Localizable {@link DoubleProperty}.
 */
class LocalizableDoubleProperty extends DoubleProperty implements LocalizableProperty<Property> {
    private LocalizableString title;
    private LocalizableString description;

    @Override
    public LocalizableDoubleProperty title(LocalizableString title) {
        this.title = title;
        return this;
    }

    @Override
    public LocalizableDoubleProperty description(LocalizableString desc) {
        this.description = desc;
        return this;
    }

    @Override
    public LocalizableDoubleProperty title(String title) {
        setTitle(title);
        return this;
    }
    ...
    @Override
    public LocalizableDoubleProperty description(String description) {
