...
public class TokenInfoParserTest {
    ...
    private OpenAmAccessTokenResolver.TokenInfoParser accessTokenParser;

    @BeforeMethod
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        when(time.now()).thenReturn(42L);
        accessTokenParser = new OpenAmAccessTokenResolver.TokenInfoParser(time);
    }
