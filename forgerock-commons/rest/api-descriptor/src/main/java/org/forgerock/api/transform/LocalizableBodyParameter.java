...
/**
 * Localizable {@link BodyParameter}.
 */
class LocalizableBodyParameter extends BodyParameter implements LocalizableParameter<BodyParameter> {
    private LocalizableString description;

    @Override
    public LocalizableBodyParameter description(LocalizableString desc) {
        this.description = desc;
        return this;
    }

    @Override
    public LocalizableBodyParameter description(String description) {
