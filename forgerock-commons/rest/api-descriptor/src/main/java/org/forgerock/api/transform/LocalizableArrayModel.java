...
class LocalizableArrayModel extends ArrayModel implements LocalizableTitleAndDescription<ArrayModel> {
    ...
    @Override
    public ArrayModel title(String title) {
        setTitle(title);
        return this;
    }

    @Override
    public ArrayModel title(LocalizableString title) {
        this.title = title;
        return this;
    }

    @Override
    public ArrayModel description(LocalizableString description) {
    ...
    @Override
    public LocalizableArrayModel description(String description) {
