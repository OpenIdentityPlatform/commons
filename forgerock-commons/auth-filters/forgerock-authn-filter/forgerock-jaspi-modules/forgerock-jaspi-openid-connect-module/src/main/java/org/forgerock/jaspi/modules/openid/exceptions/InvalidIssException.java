...
public class InvalidIssException extends OpenIdConnectVerificationException {
     ...
     */
    public InvalidIssException(final String message) {
        super(message);
    }
     ...
     */
    public InvalidIssException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause The cause.
     */
    public InvalidIssException(final Throwable cause) {
        super(cause);
    }
